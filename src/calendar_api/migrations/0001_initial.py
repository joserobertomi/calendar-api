# Generated by Django 3.2 on 2024-10-13 18:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(default='', max_length=40, unique=True, validators=[calendar_api.validators.checkDns])),
            ...
            options={
                'permissions': [('only_change_own', 'Pode alterar apenas o próprio registro na API.'), ('user_list', 'Pode Listar todos users na API'), ('user_retrieve', 'Pode recuperar um registro users na API'), ('user_update', 'Pode atualizar users na API'), ('user_partial_update', 'Pode atualizar parcialmente users na API'), ('user_create', 'Pode criar users na API'), ('user_destroy', 'Pode destruir users na API')],
                'managed': True,
            },
        ),
    ]
